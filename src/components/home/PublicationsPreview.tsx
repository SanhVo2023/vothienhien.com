...
export default function PublicationsPreview() {
  ...
  const articles = [
    { category: t('category1'), title: t('title1'), excerpt: t('excerpt1'), date: t('date1') },
    { category: t('category2'), title: t('title2'), excerpt: t('excerpt2'), date: t('date2') },
    { category: t('category3'), title: t('title3'), excerpt: t('excerpt3'), date: t('date3') },
  ];
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="mt-16 space-y-8">
          ...
          <motion.article
            ...
            className="group bg-background border border-border-gold/20 hover:shadow-lg transition-shadow duration-500 grid grid-cols-1 lg:grid-cols-2"
          >
            {/* Article image */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {articles.slice(1).map((article, index) => (
              <motion.article
                ...
                viewport={{ once: true, margin: '-50px' }}
                variants={cardVariants}
                className="group bg-background border border-border-gold/20 hover:shadow-lg transition-shadow duration-500"
              >
                {/* Article image */}
