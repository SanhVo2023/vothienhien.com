...
const practiceAreas = [
  { key: 'civil', image: IMAGES.practiceCivil },
  { key: 'land', image: IMAGES.practiceLand },
  { key: 'family', image: IMAGES.practiceFamily },
  { key: 'corporate', image: IMAGES.practiceCorporate },
  { key: 'labor', image: IMAGES.practiceLabor },
  { key: 'criminal', image: IMAGES.practiceCriminal },
] as const;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mt-16">
          {practiceAreas.map((area, index) => (
            <motion.div
              ...
              className="group relative bg-background border border-border-gold/30 hover:border-accent/60 hover:bg-secondary hover:text-white transition-all duration-500 overflow-hidden"
            >
